...
-   **Framework**: **Next.js 14+ with the App Router**. This provides a hybrid architecture of Server Components (for performance and data fetching) and Client Components (for interactivity).
